...
export const testimonials: Testimonial[] = [
  ...
  {
    name: "Dhivya Mugunthan",
    rating: 5,
    comment:
      "I attended my pregnancy yoga here and that was one of the best thing that happened in my pregnancy. Jeyanthi mam is very caring and her yoga classes helped me for vaginal birth. She pays attention to each and everyone and helps us in keeping our body healthy and active. Would highly recommend her classes for anyone looking for good yoga classes.",
  },
];
...
export const transformationStories: TransformationStory[] = [
  {
    ...
    review: {
      name: "Shofiya R",
      excerpt:
        "I was suffering from thyroid problems. Now I feel much better and my thyroid pain disappeared within a few months.",
      durationNote: "After a few months",
    },
  },
  {
    id: "pregnancy",
    title: "Prenatal Yoga & Safe Delivery",
    review: {
      name: "Dhivya Mugunthan",
      excerpt:
        "One of the best things that happened in my pregnancy. Her caring guidance kept my body healthy, active, and helped me prepare for a vaginal birth.",
      durationNote: "Throughout pregnancy",
    },
  },
  {
    id: "neck-back",
    ...
    review: {
      name: "Anugraha Ajay Prathapp",
      excerpt:
        "I joined for my neck and back pain. After 3 months, I felt relieved from the pain and my body became more flexible.",
      durationNote: "After 3 months",
    },
  },
  {
    id: "cervical",
    title: "Cervical & Nerve Issues",
    review: {
      name: "Dhivya Shankar",
      excerpt:
        "Doctors advised an MRI, but after just 5 yoga classes my symptoms disappeared and my posture improved.",
      durationNote: "After just 5 classes",
    },
  },
  {
    id: "flexibility",
    ...
    review: {
      name: "Dora Malcolm",
      excerpt:
        "Within one and a half months I regained confidence, improved mobility and was able to sit comfortably again.",
      durationNote: "Within 1.5 months",
    },
  },
];

export const trustStats = [
  { value: "500+", label: "Classes Conducted" },
  { value: "8 to 75", label: "Student Age Range" },
  { value: "East Tambaram", label: "Chennai" },
];
...
export const classes: YogaClass[] = [
  ...
  },
  {
    ...
    description:
      "Join one of our two weekday batches (Monday to Friday). A consistent, grounded practice designed to build strength, flexibility, and routine alongside a supportive community.",
    duration: "60 minutes",
    benefits: ["2 Weekday Batches", "Community Support", "Builds Consistency"],
    batches: [
      {
        id: "daily-morning",
        name: "Morning Batch",
      ...
      {
        id: "daily-mid-morning",
        name: "Mid-Morning Batch",
